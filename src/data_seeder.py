...
class DataSeeder:
    ...
    def seed_data():
        ...
        cursor.executemany("INSERT INTO leads (lead_name, phone, lead_source, status, enquiry_date) VALUES (?, ?, ?, ?, ?)", leads_data)
        ...
        cursor.executemany("INSERT INTO expenses (category, amount, expense_date, description) VALUES (?, ?, ?, ?)", expenses_data)
